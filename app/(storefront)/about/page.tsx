...
export default function AboutPage() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'About', item: 'https://engravingnation.store/about' },
    ],
  };
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <header className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-black tracking-tighter uppercase italic leading-none mb-6 text-white">
            Who Is <span className="text-brand-gold">Engraving Nation?</span>
          </h1>
        ...
        {/* GEO Answer Capsule */}
        <section id="answer" aria-label="About Overview" className="max-w-4xl mx-auto mb-16">
          <div className="p-8 rounded-3xl bg-brand-gold/[0.03] border border-brand-gold/20 backdrop-blur-sm">
            <p className="text-white/80 text-lg leading-relaxed text-center">
              ...
              Engraving Nation is a <strong>custom automotive engraving studio</strong> based in Hauppauge, NY, specializing in precision hand-etched emblems, badges, and mirror caps for Chevy, GMC, Ford, and RAM trucks. Every product is designed for OEM-level fitment and built to withstand all road conditions.
            </p>
          </div>
        </section>
        ...
        <div className="space-y-12">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="glass-card p-8 group">
              <h3 className="text-brand-gold font-heading font-black uppercase italic text-xl mb-4 group-hover:translate-x-2 transition-transform">What Vehicles Do We Specialize In?</h3>
            ...
            <div className="glass-card p-8 group">
              <h3 className="text-brand-gold font-heading font-black uppercase italic text-xl mb-4 group-hover:translate-x-2 transition-transform">How Do We Guarantee Quality?</h3>
              <p className="text-white/50 font-light leading-relaxed">
          ...
          <section className="glass-card p-8 md:p-12 text-center bg-brand-gold/5">
            <h2 className="text-2xl font-heading font-black uppercase italic mb-6 text-white">Why Do Enthusiasts Choose <span className="text-brand-gold">Engraving Nation?</span></h2>
