          ...
          <div className="space-y-12">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select 
                    ...
                    onChange={(e) => {
                      ...
                      // Reset to standard shipping for the new region
                      if (newCountry === 'US') {
                        setShippingMethod('us-standard');
                      } else {
                        setShippingMethod('int-standard');
                      }
                    }}
                  >
            ...
            <div className="glass-card p-10 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { id: 'us-standard', label: 'US Standard', price: 15, desc: '3-7 Business Days', isUS: true },
                  { id: 'us-express', label: 'US Express', price: 30, desc: '1-2 Business Days', isUS: true },
                  { id: 'int-standard', label: 'International Standard', price: 35, desc: '7-14 Business Days', isUS: false },
                  { id: 'int-express', label: 'International Express', price: 50, desc: '3-5 Business Days', isUS: false },
                ].filter(option => country === 'US' ? option.isUS : !option.isUS).map((option) => (
                  <label 
                    key={option.id}
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-black uppercase italic tracking-tight">{option.label}</span>
                      <span className="text-brand-gold font-bold">${option.price}</span>
                    </div>
                    <span className="text-[10px] text-white/40 uppercase tracking-widest">{option.desc}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="glass-card p-10 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {['Cash App', 'Zelle', 'Apple Pay', 'Chime', 'Crypto Currency'].map((method) => (
                  <label 
                    key={method}
                  ...
                  >
                    ...
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors ${
                      paymentMethod === method ? 'border-brand-gold bg-brand-gold' : 'border-white/20'
                    }`}>
                      {paymentMethod === method && <div className="w-1.5 h-1.5 rounded-full bg-black"></div>}
                    </div>
                    <span className={`text-sm font-black uppercase italic tracking-tight ${paymentMethod === method ? 'text-white' : 'text-white/60'}`}>
                      {method}
                    </span>
                  </label>
                ))}
          ...
          <div className="self-start lg:sticky lg:top-32">
            <div className="glass-card p-10 relative overflow-hidden mb-8">
              ...
              <div className="border-t border-brand-border/30 pt-8 space-y-4 mb-8">
                ...
                <div className="flex justify-between text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 leading-none">
                  <span>Shipping ({shippingMethod.replace('-', ' ').toUpperCase()})</span>
